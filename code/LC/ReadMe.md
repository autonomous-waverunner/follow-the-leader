...
software driver-libraries like [HAL](http://stm32f4-discovery.net/2015/07/all-stm32-hal-libraries/) or [CMSIS](https://developer.arm.com/tools-and-software/embedded/cmsis) should still produce the desired results with minimal configuration changes. 
